...
firtsName = document.querySelector('#playerName').value;
endGameElement();
})
function playerName() {
    document.getElementById('yourScore').textContent = 'Your score is '
+ score;
...
function endgame() {
    hasGameEnded = true;
    endGameElement.setAttribute('class' , 'visisble');
    playerScoreList.push({'playerName': playerName, 'score': score});
